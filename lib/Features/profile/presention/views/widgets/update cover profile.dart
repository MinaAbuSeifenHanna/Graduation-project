...
class UpdateCoverView extends StatelessWidget {
  const UpdateCoverView({super.key});
              ...
              body: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('please Select your photo Cover',
                    ...
                    CustomElevatedButton(onPressed: () {
                      ProfileCubit.get(context)
                          .updateCoverImage(uId!, context).then((value) {
